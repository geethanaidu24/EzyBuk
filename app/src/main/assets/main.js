...
;(function(window) {
    ...
    var selectnumber = selectbox.value;
    selectbox.addEventListener('change', function () {
        selectnumber = selectbox.value;
    });
	...
	function selectSeat(planseat) {
		...
		var seatRow = document.querySelectorAll('.row__seat--selected');
        if (seatRow.length < selectnumber) {
            ...
            alert('you can not select more than ' + selectnumber + ' seats')
        }
	}
